<header class="topbar">
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header"> <a class="navbar-brand" href="index.html">
                ...
                <span>
        <!-- dark Logo text -->
        <img src="{{asset('_admin/assets/images/Foodxyme-logo.png')}}"  alt="homepage" class="dark-logo" style="width: 120px; height: 30px;" />
                    <!-- Light Logo text -->
...
{{--                <li class="nav-item dropdown u-pro"> <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('_admin/assets/images/users/1.jpg')}}" alt="user" class="" /> <span class="hidden-md-down">Hi, {{Auth::user()->customer->name}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>--}}
