...
<!-- Mirrored from creativethemes.co.in/demo/organic-store/html/ecommerce/main/authentication-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Dec 2019 13:09:07 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="login-box card">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="{{route('admin.user.login')}}">
                    @csrf
                    <h3 class="box-title mb-20 text-center text-uppercase text-blue">FoodXyme</h3>
